...
require_once BASE_PATH . '/models/Validacao.php';
require_once BASE_PATH . '/models/Notificacao.php';
require_once BASE_PATH . '/models/Campanha.php';
require_once BASE_PATH . '/models/EventoIndicacao.php';
...
require_once BASE_PATH . '/services/ValidationProviderInterface.php';
...
require_once BASE_PATH . '/services/ValidationService.php';
